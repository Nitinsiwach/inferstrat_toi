...
test.dt= master[isTrain==0, -c(dontuse.cols, targs), with=F]
...
saveRDS(mymodel, 'finalAdamModelavgspeed12.RDS')
saveRDS(vartable, 'finalModelVarImportancesavgspeed12.RDS')
...
test= scoreWithModel(master[isTrain==0], "finalOutput_testset1aftrcorr12.csv")
train= scoreWithModel(master[isTrain==1], "finalOutput_trainset1aftrrcorr12.csv")
